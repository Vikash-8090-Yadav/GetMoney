      ...
      <div className="min-h-screen py-10 bg-gradient-to-r from-gray-700 to-gray-300">
        ...
        <div className="container mx-auto mt-3">
          ...
          <div className="md:w-1/2 py-10 px-12">
            <p className="mb-3">Monetize Your Content!!</p>
            <form>
              <div className="mt-5">
                <input placeholder="Content Name" className="border-2 border-black rounded p-4 mb-2 w-full" onChange={(e) => updateFormInput({ ...formInput, name: e.target.value })}/>
              </div>

              <div className="mt-5">
                <textarea placeholder="Content Description" className="border-2 border-black rounded p-4 mb-2 w-full" onChange={(e) => updateFormInput({ ...formInput, description: e.target.value })}/>  
              </div>
              
              <div className="mt-5">
                <input placeholder="Price in ETH" className="border-2 border-black rounded p-4 mb-2 w-full" onChange={(e) => updateFormInput({ ...formInput, price: e.target.value })}/>  
              </div>
